...
from router import (join, user, userwall, comment, group, group_post, friendship, images, order_lines, orders, product,
                    reviews, statistics,
                    create_test_data)
...
app.include_router(create_test_data.router)
app.include_router(reviews.router)

#This enables communication between localhost 8000 and 3000
origins = ["*"]
...
@app.get('/')
def index():
    return {'message': 'Hello, Welcome to the Motopp KUL-BALAM system!'}
